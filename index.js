...
var ASM_CONSTS = {
 ...
 140142: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 140225: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 140294: () => { return window.innerWidth; },  
 140324: () => { return window.innerHeight; }
};
